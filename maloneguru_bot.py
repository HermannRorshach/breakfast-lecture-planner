...
async def help_command(update: Update, context: CallbackContext):
    await update.message.reply_text(
        ...
        "Например:\nАфанасий Петров, afonya@mail.ru, 3, 2024-12-21, Если можно, кофе на безлактозном молоке\n\n"
        ...
        "Если поле <date> не заполнено, то есть два варианта:\n"
        "  1) если запрос отправлен до 17:00 пятницы, то гость записывается "
        "на обед в ближайшую субботу\n"
        "  2) если запрос отправлен после 17:00 пятницы, то гость записывается "
        "на обед в субботу следующей недели\n"
